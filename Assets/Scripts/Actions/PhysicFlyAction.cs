...
public class PhysicFlyAction : SSAction
{
    ...
    public override void Start(){
        ...
        gameObject.GetComponent<Rigidbody>().AddForce(0, 20, 0, ForceMode.Impulse);
    }
    ...
    public override void Update(){
        ...
        if (vec3.x < -100 || vec3.x > Camera.main.pixelWidth + 100 || vec3.y < -100 || vec3.y > Camera.main.pixelHeight + 200) {
            //Debug.Log("2");
            this.destroy = true;
            this.callback.SSActionEvent(this);
            return;
